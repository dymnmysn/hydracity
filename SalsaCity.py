...
class ResContextBlock(nn.Module):
    def __init__(self, in_filters, out_filters, groups=4):
        super(ResContextBlock, self).__init__()
        self.conv1 = nn.Conv2d(in_filters, out_filters, kernel_size=(1, 1), stride=1,groups=groups)
        self.act1 = nn.ReLU6()

        self.conv2 = nn.Conv2d(out_filters, out_filters, (3,3), padding=1)#,groups=groups)
        self.act2 = nn.ReLU6()
        self.bn1 = nn.BatchNorm2d(out_filters)

        self.conv3 = nn.Conv2d(out_filters, out_filters, (3,3),dilation=2, padding=2)#,groups=groups)
        self.act3 = nn.ReLU6()
